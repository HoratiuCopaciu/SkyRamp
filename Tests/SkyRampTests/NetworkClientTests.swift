...
final class NetworkClientTests: XCTestCase {
    ...
    private lazy var client = NetworkClient(networkTaskProvider: networkTaskProvider,
    ...
    func testExecuteRequestFailure() throws {
        ...
        client.execute(request: request, with: { data, response, error in
            XCTAssertNil(data)
    ...
    func testExecuteHandlerSuccess() throws {
        ...
        client.execute(handler: handler, with: { result in
            executeCallCount += 1
